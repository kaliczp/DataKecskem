jpeg("Fig5SoilMoist.jpg", width=17.8, height=11, units ="cm", res = 300)
jpeg("Fig5SoilMoist.jpg", width=17.8, height=11, units ="cm", res = 1000)
png("Fig5SoilMoist.png", width=17.8, height=11, units ="cm", res = 300)
