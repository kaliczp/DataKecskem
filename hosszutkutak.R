...
plot.zoo(kut.xts[,1], ylim = c(-5,0), xlim = FigLim, lwd = 2, xaxs = "i", col = Well.palette[1])
...
legend(as.Date("1965-01-01"), -4, legend = c("Average",names(kut.xts)), col = c("#000000", Well.palette), lwd = c(3, rep(2, length(Well.palette))))
