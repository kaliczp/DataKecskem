jpeg("Fig7Moist90cm.jpg", width=17.8, height=11, units ="cm", res = 300, pointsize = 11)
jpeg("Fig7Moist90cm1000.jpg", width=17.8, height=11, units ="cm", res = 1000, pointsize = 11)
png("Fig7Moist90cm.png", width=17.8, height=11, units ="cm", res = 300, pointsize = 11)
...
plot.zoo(Abr90cmh.xts[,1], type = "n",
         xlim = tick.day[c(1, length(tick.day))], ylim = c(0,30), yaxs = "i", xaxs = "i", xaxt = "n",
...
par(mgp = c(3, 1, 0))
lines(as.zoo(Abr90cmh.xts[,1]), lwd =2, col = 3)
lines(as.zoo(Abr90cmh.xts[,2]), lwd =2, col = 1)
lines(as.zoo(Abr90cmh.xts[,3]), lwd =2, col = 2)
par(new = TRUE)
...
box()
legend(as.POSIXct("2021-08-01 00:00"), 30, legend = c("Black Locust", "Black Pine", "Control"), col = c(1:3, "blue"), lty=1, lwd = c(2, 2, 2) , bg = "white")

# barplot(as.zoo(PrecAbr90cm.xts), col = "lightblue", ylim = c(200,0),
