...
plot.zoo(vizigori.xts, lwd = 2, xaxs = "i", yaxs = "i",
         xlim = Fig2limits, xaxt = "n",
         ylim = c(-5.4, -3.0), yaxt = "n", ylab ="", col = 3)
mtext("GW agricultural & residential [m below surface]", side = 4, line = 2.0, at = -4, las = 0, col = 3)
...
legend(as.Date("2017-03-25"), 150, legend = c("Forest", "Agricultural & residential"), col = c(1,3), lty=1, lwd = c(2, 2, 3) , bg = "white", cex = 0.8)
